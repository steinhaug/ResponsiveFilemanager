...
return [
    ...
    'Copy_Cut_Size_Limit' => 'Valitut tiedostot/hakemistot ovat liian suuria %1$s. Rajoitus: %2$d MB/toimenpide',
    // %1$s = cut or copy, %2$d = max size
    'Copy_Cut_Count_Limit' => 'Valitsit liian monta tiedostoa/hakemistoa %1$s. Rajoitus: %2$d tiedostoa/toimenpide',
    // %1$s = cut or copy, %2$d = max count
    'Copy_Cut_Not_Allowed' => 'Sinulla ei ole oikeutta %1$s %2$s.',
    ...
    'Function_Disabled' => '%s-toiminto palvelimella on kytketty pois päältä.',
    // %s = cut or copy
    'File_Permission' => 'Tiedoston oikeus',
    'File_Permission_Not_Allowed' => '%s oikeuksien muuttaminen ei ole sallittua.',
    // %s = files or folders
    ...
    'File_Open_Edit_Not_Allowed' => 'Et voi %s tätä tiedostoa.',
    // %s = open or edit
    'Edit' => 'Muokkaa',
    ...
    'Valid_Extensions' => 'Hyväksyttyjä tiedostopäätteitä: %s',
    // %s = txt,log etc.
    ...
    'max_size_reached' => "Kuvahakemistosi on saavuttanut suurimman mahdollisen koon %d MB.",
    //%d = max overall size
    'B' => "B",
    'KB' => "KB",
    'MB' => "MB",
