...
define('USE_SESSION_ENABLE_KEY', true); // TRUE or FALSE
...
if (USE_SESSION_ENABLE_KEY == true) {
    if (!isset($_SESSION['TINYMCE_ENABLED']) or !$_SESSION['TINYMCE_ENABLED']) {
        die('Missing privilege, Access Denied!');
    }
}
...
$config = [
    ...
    */
    ...
    |
    */
    'upload_dir' => '/files/filemanager_uploads/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'current_path' => '../../../files/filemanager_uploads/',
    ...
    |
    */
    'thumbs_base_path' => '../../../files/filemanager_thumbs/',
    ...
    |
    */
    'thumbs_upload_dir' => '/files/filemanager_thumbs/',
